<main>
    <div class="fundo">
        <div class="categoria">
                ...
                <div class="category">
                        <button data-filtros type="button" class="category__button">
                            <span class="button__title">Filtros</span>
                        ...
                        <div data-category2 class="category">
                            ...
                            <ul data-item="1" class="category__item">
                                <li><span class="category__Produtos"><input name="genero[]" value="Masculino" class="category__checkbox" type="checkbox" id="2Opção1__1"><label for="2Opção1__1">Masculino</label></span></li>
                                <li><span class="category__Produtos"><input name="genero[]" value="Feminino" class="category__checkbox" type="checkbox" id="2Opção1__2"><label for="2Opção1__2">Feminino</label></span></li>
                                <li><span class="category__Produtos"><input name="genero[]" value="Unissex" class="category__checkbox" type="checkbox" id="2Opção1__3"><label for="2Opção1__3">Unissex</label></span></li>
                            </ul>
                        </div>
                        ...
                        <div data-category2 class="category">
                            ...
                            <ul data-item="1" class="category__item2">
                                <div class="tamanho__grid">
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="36" class="category__checkbox2" type="checkbox" id="2Opção4__1"><label for="2Opção4__1">36</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="37" class="category__checkbox2" type="checkbox" id="2Opção4__2"><label for="2Opção4__2">37</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="38" class="category__checkbox2" type="checkbox" id="2Opção4__3"><label for="2Opção4__3">38</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="39" class="category__checkbox2" type="checkbox" id="2Opção4__4"><label for="2Opção4__4">39</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="40" class="category__checkbox2" type="checkbox" id="2Opção4__5"><label for="2Opção4__5">40</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="41" class="category__checkbox2" type="checkbox" id="2Opção4__6"><label for="2Opção4__6">41</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="42" class="category__checkbox2" type="checkbox" id="2Opção4__7"><label for="2Opção4__7">42</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="43" class="category__checkbox2" type="checkbox" id="2Opção4__8"><label for="2Opção4__8">43</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="44" class="category__checkbox2" type="checkbox" id="2Opção4__9"><label for="2Opção4__9">44</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="45" class="category__checkbox2" type="checkbox" id="2Opção4__10"><label for="2Opção4__10">45</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="46" class="category__checkbox2" type="checkbox" id="2Opção4__11"><label for="2Opção4__11">46</label></span></li>
                                    <li><span class="category__Produtos2"><input name="tamanhos[]" value="47" class="category__checkbox2" type="checkbox" id="2Opção4__12"><label for="2Opção4__12">47</label></span></li>        
                                </div>
                            </ul>
                        </div>
                        ...
                        <div data-category2 class="category">
                            ...
                            <ul data-item="1" class="category__item">
                                <li><span class="category__Produtos"><input name="departamento[]" value="Corrida" class="category__checkbox" type="checkbox" id="2Opção2__1"><label for="2Opção2__1">Corrida</label></span></li>
                                <li><span class="category__Produtos"><input name="departamento[]" value="Caminhada" class="category__checkbox" type="checkbox" id="2Opção2__2"><label for="2Opção2__2">Caminhada</label></span></li>
                                <li><span class="category__Produtos"><input name="departamento[]" value="Basquete" class="category__checkbox" type="checkbox" id="2Opção2__3"><label for="2Opção2__3">Basquete</label></span></li>
                                <li><span class="category__Produtos"><input name="departamento[]" value="Futebol" class="category__checkbox" type="checkbox" id="2Opção2__4"><label for="2Opção2__4">Futebol</label></span></li>
                                <li><span class="category__Produtos"><input name="departamento[]" value="Esportes" class="category__checkbox" type="checkbox" id="2Opção2__5"><label for="2Opção2__5">Esportes de Quadra</label></span></li>
                                <li><span class="category__Produtos"><input name="departamento[]" value="Automobilismo" class="category__checkbox" type="checkbox" id="2Opção2__6"><label for="2Opção2__6">Automobilismo</label></span></li>
                                <li><span class="category__Produtos"><input name="departamento[]" value="Moda" class="category__checkbox" type="checkbox" id="2Opção2__7"><label for="2Opção2__7">Moda</label></span></li>
                            </ul>
                        </div>
                        ...
                        <div data-category2 class="category">
                            ...
                            <ul data-item="1" class="category__item">
                                <li><span class="category__Produtos"><input name="marcas[]" value="Adidas" class="category__checkbox" type="checkbox" id="2Opção3__1"><label for="2Opção3__1">Adidas</label></span></li>
                                <li><span class="category__Produtos"><input name="marcas[]" value="Asics" class="category__checkbox" type="checkbox" id="2Opção3__2"><label for="2Opção3__2">Asics</label></span></li>
                                <li><span class="category__Produtos"><input name="marcas[]" value="Mizuno" class="category__checkbox" type="checkbox" id="2Opção3__3"><label for="2Opção3__3">Mizuno</label></span></li>
                                <li><span class="category__Produtos"><input name="marcas[]" value="Nike" class="category__checkbox" type="checkbox" id="2Opção3__4"><label for="2Opção3__4">Nike</label></span></li>
                                <li><span class="category__Produtos"><input name="marcas[]" value="Puma" class="category__checkbox" type="checkbox" id="2Opção3__5"><label for="2Opção3__5">Puma</label></span></li>
                                <li><span class="category__Produtos"><input name="marcas[]" value="Olympikus" class="category__checkbox" type="checkbox" id="2Opção3__6"><label for="2Opção3__6">Olympikus</label></span></li>
                            </ul>
                        </div>
        ...
        <div class="fundo2">
            <div class='card__grid'>
                ...
                if (!empty($sql)) {
                    ...
                    $and = " LIMIT $limite OFFSET $offset;";

                    $sql2 = $sql . $and;
                    
                    $sql_query2 = $categoria->con->prepare($sql2);
                    $sql_query2->execute();
                    $quantidade2 = $sql_query2->rowCount()
                    ;
                    if($quantidade2 == 0){
                        echo "<p>Sinto muito! Não temos produtos com essas especificações...</p>";
                    }
                
                    /*===== SELECIONA LINHAS E DADOS DO BANCO =====*/
                    while (($produto = $sql_query2->fetch(PDO::FETCH_ASSOC))) {
            ...
            <ul>
              <li><a class='ponta esquerda'><i class='bi bi-arrow-left'></i></a></li>
                ...
                for($i = 0; $i < $Inteiro; $i++){
                    $numeração = $i + 1;
                    echo "<li>";
                        echo "<a href='Untitled-1.php?pagina=$i'>$numeração</a>";
                    echo "</li>";
                }?>
...
<script>
  if (performance.navigation.type === 2) {
    // Limpa os valores dos campos do formulário da classe "telapequena"
    document.querySelector(".telapequena").reset();
    
    // Limpa os valores dos campos do formulário da classe "telagrande"
    document.querySelector(".telagrande").reset();
