<main>
    <div class="fundo">
        <div class="card__login">
            ...
            <div class="color">
                <div class="color__textos">
                    <p class="color__titulo">ADOLETA STORAGE</p>
                    <p class="color__texto">Compre Seus Calçados com Segurança e Facilidade! Um Site Totalmente Confiavel e Intuitivo!</p>
                </div>
            </div>
        </div>
    </div>
